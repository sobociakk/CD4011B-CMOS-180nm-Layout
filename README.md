...
## Overview
This repository contains a full-custom physical design of a CD4011B equivalent integrated circuit. The project was developed from schematic entry down to the physical layout and post-layout verification as part of an academic project
...
![s_rise](cd4011b/img/s_rise.png)
*The rise time is 0.86 ns.*
![s_fall](cd4011b/img/s_fall.png)
*The fall time is 0.65 ns.*

### Threshold voltage
![th_voltage](cd4011b/img/th_voltage.png)
*The threshold voltage is 697 mV.*

### DC current consumption
![idd_cons](cd4011b/img/idd_cons.png)
*Averge DC current consumption is 1.40 mA, with a peak of 50 mA.*

## Single gate layout
![gate_lay](cd4011b/img/gate_lay.png)

## Gate with buffer stages
![gateb_lay](cd4011b/img/gateb_lay.png)

## ESD protection + Pad
![esd_pad](cd4011b/img/esd_pad.png)

## Layout topography
![layout](cd4011b/img/layout.png)
...
![s_rise_pe](cd4011b/img/s_rise_pe.png)
*The rise time is 0.87 ns.*
![s_fall_pe](cd4011b/img/s_fall_pe.png)
*The fall time is 0.65 ns.*

### Post-extraction Threshold voltage
![th_voltage_pe](cd4011b/img/th_voltage_pe.png)
*The threshold voltage is 697 mV.*
